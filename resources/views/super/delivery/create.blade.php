    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.Delivery.store') }}">
                ...
                <div class="row mb-3">
                    <label for="carte" class="col-md-4 col-form-label text-md-end">{{ __('Carte Grise ') }}</label>

                    <div class="col-md-6">
                        <input id="carte" type="text" class="form-control @error('carte') is-invalid @enderror" name="carte" value="{{ old('carte') }}" required autocomplete="carte" autofocus>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <select name="city" id="city" class="custom-select custom-select-sm text-dark">
